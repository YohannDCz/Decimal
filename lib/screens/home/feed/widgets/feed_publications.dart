            ...
            child: Padding(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  late final PublicationModel publication = state.fetchAllSuccess['publications'][index];
                  late final PublicationItemModel publicationItem = state.fetchAllSuccess['publicationItems'][index];
                  late final CustomUser user = state.fetchAllSuccess['users'][index];
                  late final List<CommentModel> comments = state.fetchAllSuccess['comments'][index];
                  late final List<CustomUser> commentUsers = state.fetchAllSuccess['commentsUsers'][index];
