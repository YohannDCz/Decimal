...
class ProfileUserPublications extends StatefulWidget {
  const ProfileUserPublications({
    super.key,
  });

  @override
  State<ProfileUserPublications> createState() => _ProfileUserPublicationsState();
}

class _ProfileUserPublicationsState extends State<ProfileUserPublications> {
