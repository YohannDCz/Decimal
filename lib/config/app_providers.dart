  ...
  Widget build(BuildContext context) {
    return MultiRepositoryProvider(
      providers: [
        ...
        RepositoryProvider(create: (_) => ReactionService()),
        RepositoryProvider(create: (_) => VisionService()),
      ],
      child: MultiBlocProvider(
          providers: [
            BlocProvider(create: (context) => AuthenticationBloc(authenticationService: context.read<AuthenticationService>())),
            BlocProvider(create: (context) => ProfileContentBloc(profileContentService: context.read<ProfileContentService>())),
            BlocProvider(create: (context) => FeedBloc(feedService: context.read<FeedService>())),
            BlocProvider(create: (context) => ProfileBloc(profileService: context.read<ProfileService>(), profileContentService: context.read<ProfileContentService>())),
            BlocProvider(create: (context) => ReactionBloc(reactionService: context.read<ReactionService>())),
            BlocProvider(create: (context) => PublicationBloc(profileService: context.read<ProfileService>())),
          ],
